        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yuyuexinxi','检查') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jianchaxinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','')">{{ contents.tableBtnFont == 1?'检查':'' }}</el-button>
                <el-button v-if="isAuth('yuyuexinxi','检查') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jianchaxinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','')">{{ contents.tableBtnFont == 1?'检查':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuyuexinxi','检查') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jianchaxinxiCrossAddOrUpdateHandler(scope.row,'cross','否','','')">{{ contents.tableBtnFont == 1?'检查':'' }}</el-button>
