<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="禁忌" prop="jinji">
          <el-input v-model="ruleForm.jinji" 
              placeholder="禁忌" clearable  :readonly="ro.jinji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="禁忌" prop="jinji">
              <el-input v-model="ruleForm.jinji" 
                placeholder="禁忌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
