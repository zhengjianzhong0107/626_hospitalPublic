<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="项目位置" prop="xiangmuweizhi">
          <el-input v-model="ruleForm.xiangmuweizhi" 
              placeholder="项目位置" clearable  :readonly="ro.xiangmuweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="项目位置" prop="xiangmuweizhi">
              <el-input v-model="ruleForm.xiangmuweizhi" 
                placeholder="项目位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目介绍" prop="xiangmujieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmujieshao" label="项目介绍" prop="xiangmujieshao">
                    <span>{{ruleForm.xiangmujieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmujieshao = true;
          ...
          if(o=='xiangmuweizhi'){
            this.ruleForm.xiangmuweizhi = obj[o];
	    this.ro.xiangmuweizhi = true;
            continue;
          }
          if(o=='yishenggonghao'){
