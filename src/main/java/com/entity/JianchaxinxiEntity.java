...
public class JianchaxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：检查编号
	 */
	public void setJianchabianhao(String jianchabianhao) {
		this.jianchabianhao = jianchabianhao;
	}
	/**
	 * 获取：检查编号
	 */
	public String getJianchabianhao() {
		return jianchabianhao;
	}
	/**
	 * 设置：项目名称
	 */
